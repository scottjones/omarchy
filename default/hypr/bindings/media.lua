...
o.bind("SHIFT + XF86MonBrightnessUp", "Brightness maximum", "omarchy-brightness-shift up", { locked = true, repeating = true })
o.bind("SHIFT + XF86MonBrightnessDown", "Brightness minimum", "omarchy-brightness-shift down", { locked = true, repeating = true })
